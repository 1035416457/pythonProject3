...
class ApComUsr( BasePage ):
    ...
    submit = (selenium.webdriver.common.by.By.CLASS_NAME, ".item:nth-child(9)")
    s = (selenium.webdriver.common.by.By.XPATH, "//div[5]/div/div[Test03]")
    ...
    def  xy(self,text,text1):
        self.move_by_offset(text,text,self.s)
    def item_btn(self):
